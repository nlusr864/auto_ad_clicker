...
def ad_click():
    ...
    sleep(5)
    driver.find_element(By.XPATH, "//span[text()='१']").click()
    sleep(7)
    ...
    sleep(5)
    driver.find_element(By.CSS_SELECTOR, "img[src='https://www.onlinekhabar.com/wp-content/uploads/2022/05/ezgif.com-gif-maker8.gif']").click()
    sleep(5)
